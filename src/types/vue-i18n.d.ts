 ...
 * @VueI18nGeneral
 */
export declare const castToVueI18n: (i18n: I18n) => VueI18n<
  {},
  {},
  {},
  string,
...
export declare type ComponentInstanceCreatedListener = <Messages>(
 ...
 * @VueI18nComposition
 */
export declare interface ComposerDateTimeFormatting<
  DateTimeFormats = {},
  Locales = "en-US",
 ...
 * @VueI18nComposition
 */
export declare interface ComposerNumberFormatting<
  NumberFormats = {},
  Locales = "en-US",
 ...
 * @VueI18nComposition
 */
export declare interface ComposerResolveLocaleMessageTranslation<
  Locales = "en-US",
> {
  /**
   * Resolve locale message translation
...
export declare type CustomBlocks<Message = VueMessageType> = Array<
  CustomBlock<Message>
>;
 ...
 * @VueI18nGeneral
 */
export declare interface DefineLocaleMessage
  extends LocaleMessage<VueMessageType> {}
 ...
 * @VueI18nComponent
 */
export declare interface FormattableProps<Value, Format>
  extends BaseFormatProps {
  /**
   * @remarks
...
/** @VueI18nLegacy */
export declare type LocaleMessageObject<Message = string> =
...
/** @VueI18nComposition */
export declare type MissingHandler = (
  locale: Locale,
  key: Path,
...
export declare function vTDirective(
  i18n: I18n,
 ...
 * @VueI18nLegacy
 */
export declare interface VueI18nDateTimeFormatting<
  DateTimeFormats = {},
  Locales = "en-US",
  DefinedDateTimeFormat extends
    RemovedIndexResources<DefineDateTimeFormat> = RemovedIndexResources<DefineDateTimeFormat>,
 ...
 * @VueI18nLegacy
 */
export declare interface VueI18nNumberFormatting<
  NumberFormats = {},
  Locales = "en-US",
  DefinedNumberFormat extends
    RemovedIndexResources<DefineNumberFormat> = RemovedIndexResources<DefineNumberFormat>,
 ...
 * @VueI18nLegacy
 */
export declare type VueI18nResolveLocaleMessageTranslation<Locales = "en-US"> =
 ...
 * @VueI18nLegacy
 */
export declare interface VueI18nTranslation<
  Messages = {},
  Locales = "en-US",
  DefinedLocaleMessage extends
    RemovedIndexResources<DefineLocaleMessage> = RemovedIndexResources<DefineLocaleMessage>,
 ...
 * @VueI18nLegacy
 */
export declare interface VueI18nTranslationChoice<
  Messages = {},
  Locales = "en-US",
  DefinedLocaleMessage extends
    RemovedIndexResources<DefineLocaleMessage> = RemovedIndexResources<DefineLocaleMessage>,
